...
const createTicketSchema = z.object({
  body: z.object({
    ...
    issueDescription: z.string({ required_error: 'Issue description is required' }),
    ...
    preferredHandover: z.enum(['pickup', 'dropoff']).optional()
  })
});
...
const addRepairLogSchema = z.object({
  body: z.object({
    type: z.enum(['update', 'part_ordered', 'part_received', 'delay', 'other'], { required_error: 'Log type is required' }),
